(() => {
    ...
    function initSliders() {
        if (document.querySelector(".block-best__slider")) new core(".block-best__slider", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 3,
        ...
        if (document.querySelector(".item-say__slider")) new core(".item-say__slider", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
            ...
            loop: true,
            navigation: {
                prevEl: ".item-say__prev",
                nextEl: ".item-say__next"
            },
            on: {}
        });
    }
