(() => {
    ...
    (() => {
        ...
        function initSliders() {
            if (document.querySelector(".declaration__slider")) new core(".declaration__slider", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                slidesPerView: 3,
            ...
            if (document.querySelector(".jobs__slider")) new core(".jobs__slider", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                slidesPerView: 3,
                ...
                watchSlidesVisibility: true,
                navigation: {
                    prevEl: ".jobs__arrow-prev",
                    nextEl: ".jobs__arrow-next"
                },
                breakpoints: {
                    320: {
                        slidesPerView: 1,
